                ...
                >
                    <Grid item display={"flex"} alignItems={"center"} gap={"10px"}>
                        ...
                        <Typography variant="p"
                            ...
                            color={"#fff"}
                            marginLeft={"5px"}>
                            <a href="https://wa.me/5493774491666/?text=Hola , por favor dejame tu mensaje y lo respondere cuando antes..." target="_blank" rel="noreferrer">(+549)3774-491666</a>
                        </Typography>
                    </Grid>
                </motion.div>
                <motion.div
                ...
                >
                    <Grid item display={"flex"} alignItems={"center"} gap={"10px"}>
                        ...
                        <Typography variant="p"
                            ...
                            color={"#fff"}
                            marginLeft={"5px"}>
                            <a href="https://www.linkedin.com/in/alefernandez88/" target="_blank" rel="noreferrer">in/alefernandez88</a>
                        </Typography>
                    </Grid>
                </motion.div>
            </Grid>
